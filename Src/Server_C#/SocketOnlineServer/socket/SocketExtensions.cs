...
public static class SocketExtensions
{
    ...
    /// <returns></returns>
    public static IEnumerable<Message> ReadStrings(this UserConnector userconnector, CancellationToken cancellationToken, string eom = "<EOM>", string eof = "<EOF>")
    {
        var client = userconnector.client;
    ...
    /// <param name="eom"></param>
    /// <returns></returns>
    public async static Task WriteStringAsync(this UserConnector userconnector, string s, string eom = "<EOM>")
    {
        var client = userconnector.client;
