...
public class Friend
{
    ...
    [JsonProperty("group")]
    public int group { get; set; } //好友所在的组。1组为默认组“我的好友”，-1为默认组“黑名单”。0组为默认组“我的电脑/手机”，2组为默认组“陌生人”。
    [JsonProperty("friendShip")]
    public int friendShip { get; set; } //好友的关系。1：特别关注好友；0：正常好友；2：黑名单。
    [JsonProperty("remark")]
...
/*
HashMap<String key ,List<GroupInfo> group_info>
